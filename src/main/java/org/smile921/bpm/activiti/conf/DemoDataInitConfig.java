package org.smile921.bpm.activiti.conf;
...
import org.smile921.bpm.activiti.util.PropertyFileUtil;
...
public class DemoDataInitConfig {
    ...
    protected void initDemoUsers() {
        createUser("admin", "Smile", "Frere", "000000", "smile921.frere@smile.org",
                "", Arrays.asList("user", "admin"), null);

        createUser("hruser", "Lili", "Zhang", "000000", "lili.zhang@smile.org",
                "", Arrays.asList("hr", "user"), null);

        createUser("leaderuser", "Jhon", "Li", "000000", "jhon.li@smile.org",
                "", Arrays.asList("deptLeader", "user"), null);

        createUser("frere", "Coffee", "Rabbit", "000000", "coffee.rabbit@smile.org",
                "", Arrays.asList("user", "admin"), null);
    }
