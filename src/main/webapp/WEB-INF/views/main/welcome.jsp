...
<%@page import="org.smile921.bpm.activiti.util.PropertyFileUtil"%>
...
<body style="margin-top: 1em;">
    ...
    <div id="multiInstance" class="template">
        在填写<strong>会签参与人</strong>字段时使用用户的ID作为值，例如：<code>frere,admin</code>表示两个用户，即两个任务实例被创建。
    </div>
    <div class="project-info template">
        <ul>
            <li> 为Activiti初学者快速入门所设计。</li>
            <li>源代码托管Github： </li>
        </ul>
    </div>
